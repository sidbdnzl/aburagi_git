...
//     const onScroll = () => {
//         const rect = aburagi.getBoundingClientRect();
//         const scrollY = window.scrollY;

//         const aburagiTop = scrollY + rect.top;
//         const aburagiBottom = scrollY + rect.bottom;

//         const triggerPoint = scrollY + window.innerHeight * 0.1;

//         const inSection = triggerPoint > aburagiTop && triggerPoint < aburagiBottom;

//         // ナビリンク
//         gnavLinks.forEach(link => link.classList.toggle("is-white", inSection));

//         // ロゴ画像
//         if (koubouImg) {
//             koubouImg.classList.toggle("is-white", inSection);
//         }

//         // ハンバーガー
//         if (hamburger) {
//             hamburger.classList.toggle("is-white", inSection);
//         }
