...
<main class="main">
    ...
    <section class="aburagi fadein" data-midnight="white">
        <div class="aburagi__inner">
    ...
    <section class="seimai fadein">
        <div class="seimai__inner">
    ...
    <section class="kome fadein">
        <div class="kome__inner">
            ...
            <div class="kome__scroller mySwiper">
                <div class="kome__images swiper-wrapper">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/niigata_koshihikari.webp" alt="新潟産コシヒカリのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/aichi_koshihikari.webp" alt="愛知県産コシヒカリのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/toyama_koshihikari.webp" alt="富山県産コシヒカリのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/nagano_koshihikari.webp" alt="長野県産コシヒカリのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/uonuma_koshihikari.webp" alt="魚沼産コシヒカリのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/toyama_fufufu.webp" alt="富山県産富富富のパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/aichi_no_kaori.webp" alt="あいちのかおりのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/nikomaru.webp" alt="にこまるのパッケージ画像">
                    <img class="swiper-slide" src="<?php echo get_template_directory_uri(); ?>/image/kome/hitomebore.webp" alt="ひとめぼれのパッケージ画像">
